        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <a href="#posts" class="btn-accent btn">Explore Posts <i class="fas fa-arrow-down ms-2"></i></a>
            ...
            <div class="col-lg-5 d-none d-lg-block">
                ...
                <div class="mt-3 p-3 rounded-3" style="background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.12);">
                    ...
                    <a href="posts.php?id=<?= $fp['id'] ?>" style="color:rgba(255,255,255,0.6);font-size:0.8rem;">Read now →</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div class="col-md-6 fade-in-up">
                    <div class="post-card">
                        ...
                        <div class="post-card-body">
                            <h3 class="post-card-title"><a href="posts.php?id=<?= $post['id'] ?>"><?= sanitize($post['title']) ?></a></h3>
        ...
        <div class="col-lg-4">
            ...
            <div class="sidebar-widget">
                ...
                <div class="recent-post-item">
                    ...
                    <?php endif; ?>
                    <div>
                        <a href="posts.php?id=<?= $rp['id'] ?>" class="recent-post-title"><?= sanitize($rp['title']) ?></a>
